<template>
    <modal>
        ...
        <form method="post" @submit.prevent="saveMeeting()" id="addMeetingForm" @input="form.errors.clear($event.target.name)" >
            <div class="md-layout">
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                    <md-field>
                        <div class="md-field md-theme-default md-has-value">
                            ...
                            <select class="select md-menu md-select" v-model="form.programName"
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                    <md-field>
                        <div class="md-field md-theme-default md-has-value">
                            ...
                            <select class="select md-menu md-select" v-model="form.serviceProvided"
                                name="serviceProvided" id="serviceProvided">
                                <option v-for="(serviceProvided, index) in servicesProvided.items" :key="index" :value="serviceProvided.item">
                                    {{ serviceProvided.item }} </option>
                            </select>
                        </div>
                    </md-field>
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                    ...
                    <datepicker :bootstrap-styling="true" v-model="form.date" format="YYYY-MM-DD" id="date" @input="form.errors.clear('date')"></datepicker>

                     <span class="help is-danger" v-if="form.errors.has('date')"
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                        <md-field>
                            <div class="md-field md-theme-default md-has-value">
                                ...
                                <select class="select md-menu md-select" v-model="form.duration"
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                    <md-field>
                        <div class="md-field md-theme-default md-has-value">
                            ...
                            <select class="select md-menu md-select" v-model="form.type"
                                name="type" id="type">
                                <option v-for="(type, index) in meetingTypes.items" :key="index" :value="type.item">
                                    {{ type.item }} </option>
                            </select>
                        </div>
                    </md-field>
                    ...
                    <md-field>
                        <div class="md-field md-theme-default md-has-value">
                            ...
                            <select class="select md-menu md-select" v-model="form.status"
                                name="status" id="status" @input="form.errors.clear($event.target.name)">
                                <option v-for="(status, index) in meetingStatuses.items" :key="index" :value="status.item">
                                    {{ status.item }} </option>
                            </select>
                        </div>
                    </md-field>
                ...
                <div class="md-layout-item md-small-size-100 md-size-50">
                    <md-field>
                        <div class="md-field md-theme-default md-has-value">
                            ...
                            <select class="select md-menu md-select" v-model="form.serviceDelivery"
                                name="serviceDelivery" id="serviceDelivery">
                                <option v-for="(serviceDelivery, index) in serviceDeliveries.items" :key="index" :value="serviceDelivery.item">
                                    {{ serviceDelivery.item }} </option>
                            </select>
                        </div>
                    </md-field>
                    <span class="help is-danger" v-if="form.errors.has('serviceDelivery')"
                          v-text="form.errors.get('serviceDelivery')"></span>
                </div>
          ...
          <template slot="footer">
            <button class="button is-success" type="submit" form="addMeetingForm" :disabled="saveDisabled">
                <span> Save </span>
...
export default {
    ...
    methods: {
        ...
        saveMeeting() {
            ...
            if (this.meetingEdit) {
                this.form.put('api/meeting/' + this.meetingEdit.id)
                    .then(response => {
